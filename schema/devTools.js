...
export const devTools = [
    {
        ...
        parameters: {
            ...
            properties: {
                prompt: {
                    type: Type.STRING,
                    description: "Mô tả chi tiết nội dung cần kiểm tra dữ liệu, khởi chạy tính năng hoặc tạo tính năng mới (ví dụ: 'Chơi 7 viên ngọc rồng', 'Kiểm tra log nội bộ của worker', 'Tạo lệnh tung xúc xắc')."
                },
                feature_name: {
                    type: Type.STRING,
